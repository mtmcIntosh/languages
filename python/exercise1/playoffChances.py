...
team=1
results=[]
outcomeMatrix=numpy.zeros(shape=(5,3))
playoffs=""
len2=0
len3=0
len4=0
...
if ((outcomeMatrix[0,0] and outcomeMatrix[1,1]) and
    (outcomeMatrix[2,0] and (outcomeMatrix[4,1] or outcomeMatrix[4,2])  )):
    playoffs="will"
elif ((outcomeMatrix[0,0] and outcomeMatrix[1,1]) and
    (outcomeMatrix[2,0] and (outcomeMatrix[3,1] or outcomeMatrix[3,2])  )):
    playoffs="will"
elif (outcomeMatrix[0,0] and outcomeMatrix[1,1] and
    outcomeMatrix[4,0] and outcomeMatrix[3,0] and
      (outcomeMatrix[2,1] or outcomeMatrix[2,2]) ):
    playoffs="will"
else:
    playoffs="will not"
